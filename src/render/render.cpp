...
void renderPlane(pcl::visualization::PCLVisualizer::Ptr& viewer, std::vector<float> Pt1, std::vector<float> Pt2, std::vector<float> Pt3)
{
	viewer->addLine(pcl::PointXYZ(Pt1.at(0), Pt1.at(1), Pt1.at(2)), pcl::PointXYZ(Pt2.at(0),Pt2.at(1),Pt2.at(2)),1,0,0);
	viewer->addLine(pcl::PointXYZ(Pt1.at(0), Pt1.at(1), Pt1.at(2)), pcl::PointXYZ(Pt3.at(0),Pt3.at(1),Pt3.at(2)),1,0,0);
	viewer->addLine(pcl::PointXYZ(Pt3.at(0), Pt3.at(1), Pt3.at(2)), pcl::PointXYZ(Pt2.at(0),Pt2.at(1),Pt2.at(2)),1,0,0);
}
